...
dule to  test the Rectangle class """
"""
...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_incorrect_amount_attrs(self):
        """ 1 arg passed test error """
        with self.assertRaises(TypeError):
            new = Rectangle(1)

    def test_incorrect_amount_attrs_1(self):
        """ no args passed test error"""
        with self.assertRaises(TypeError):
            new = Rectangle()
    ...
    def test_str_3(self):
        """ Testing return value of __str__ """
        r1 = Rectangle(5, 10)
